    ...
    return (
        <div className="container">
            <div className="row my-5 p-5">
                <h2 className='text-center fs-4'>We pioneered the discount broking model in India.</h2>
                <h2 className='text-center fs-4'>Now, we are breaking ground with our technology.</h2>
            </div>
            <div className="row my-4 p-5 border-top">
